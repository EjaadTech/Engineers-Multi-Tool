...
void Menu()
{
	...
	else if (count == 3 && ButtonRead > 700 && ButtonRead < 800)
	{
		while (ButtonRead < 800)
		{
			...
			ButtonRead = analogRead(A7);
			display.clearDisplay();
			display.print("Press Start ToBegin....!");
			display.display();
			delay(100);
			if (ButtonRead > 700 && ButtonRead < 800)
			SemiProbing();
...
void MenuUp()
{
	...
	{ 
		...
		display.print(menu[count == 0 ? 3 : (count - 1)]);
		display.setCursor(0, i-48);
...
void VoltageRead()
{
	...
	while (ButtonRead < 800)
	{
		...
		VoltageA = analogRead(A6)*5.0 / 1023.0;
		VoltageA = VoltageA * 11;
		VoltageB = analogRead(A5)*5.0 / 1023.0;
...
void SemiProbing()
{
	...
	while ((ButtonRead = analogRead(A7)) < 800);
	delay(500);                                   //Let the user read the text
